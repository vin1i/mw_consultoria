...
import { ServicosContainer, ServicoCard, Image, Text, WhatsAppButton, TituloServicos } from "./ServicosStyles";
    ...
    <div style={{ backgroundColor: "var(--grey)" }}>
      ...
      <ServicosContainer>
        ...
        <ServicoCard>
          ...
          <Text>
            ...
            <p>
              ...
              e venda de imóveis, com uma abordagem transparente e focada
              no seu sucesso.
            </p>
          </Text>
        </ServicoCard>
        ...
        <ServicoCard>
          ...
          <div style={{ fontSize: "1.3rem", margin: "0", padding: "0 0px", maxWidth: "550px" }}>
        ...
        <WhatsAppButton href="https://api.whatsapp.com/send?phone=5511999999999&text=Ol%C3%A1%2C%20gostaria%20de%20saber%20mais%20sobre%20os%20servi%C3%A7os%20da%20MW%20Consultoria.">
          Fale conosco!
          <FaWhatsapp style={{ color: "white", fontSize: "25px" }} /> {/* Ícone branco */}
        </WhatsAppButton>
      </ServicosContainer>
    </div>
  );
